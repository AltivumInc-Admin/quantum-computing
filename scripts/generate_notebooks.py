...
if __name__ == "__main__":
    ...
    # 02-hardware notebooks
    notebooks_01 = [
        (
            "02-hardware/notebooks/01-device-discovery.ipynb",
            "Device Discovery",
        ...
        (
            "02-hardware/notebooks/03-iqm-exploration.ipynb",
            "IQM Superconducting Exploration",
            "Work with nearest-neighbor topology and transpilation.",
        ),
        (
            "02-hardware/notebooks/04-quera-analog.ipynb",
    ...
    # 05-quantum-chemistry notebooks
    notebooks_04 = [
        (
            "05-quantum-chemistry/notebooks/01-molecular-hamiltonians.ipynb",
            "Molecular Hamiltonians",
            "Build H2 and LiH Hamiltonians using OpenFermion and PySCF.",
        ),
        (
            "05-quantum-chemistry/notebooks/02-fermion-qubit-mapping.ipynb",
        ...
        (
            "05-quantum-chemistry/notebooks/04-vqe-lih.ipynb",
        ...
        (
            "05-quantum-chemistry/notebooks/06-active-space.ipynb",
        ...
        (
            "05-quantum-chemistry/notebooks/08-hybrid-chemistry-job.ipynb",
    ...
    # 06-hybrid-jobs notebooks
    notebooks_05 = [
        (
            "06-hybrid-jobs/notebooks/01-first-hybrid-job.ipynb",
            "Your First Hybrid Job",
            "Create, submit, and monitor a simple Braket Hybrid Job.",
        ),
        (
            "06-hybrid-jobs/notebooks/02-parametric-compilation.ipynb",
            "Parametric Compilation",
            "Speed up variational algorithms by compiling circuits once.",
        ),
        (
            "06-hybrid-jobs/notebooks/03-monitoring-metrics.ipynb",
            "Real-Time Monitoring",
            "Log and visualize custom metrics with CloudWatch integration.",
        ),
        (
            "06-hybrid-jobs/notebooks/04-checkpointing.ipynb",
            "Checkpointing & Recovery",
            "Save and restore state for fault-tolerant long-running jobs.",
        ),
        (
            "06-hybrid-jobs/notebooks/05-custom-containers.ipynb",
            "Custom Containers",
            "Build and deploy custom Docker images for specialized jobs.",
        ),
        (
            "06-hybrid-jobs/notebooks/06-pennylane-jobs.ipynb",
