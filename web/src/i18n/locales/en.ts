...
export const en: TranslationDict = {
  ...
  home: {
    ...
    dialLabel: "Curriculum sections on the dial",
    hudLive: "Simulator live · in-browser",
    hudCounts: "{{sections}} sections · {{notebooks}} notebooks",
    badgeFree: "Free",
    badgeInBrowser: "In-browser",
    badgeNoInstall: "No install",
    dialOpenSection: "Open section",
    dialClose: "Close",
    notebooksCount: {
      one: "{{count}} notebook",
