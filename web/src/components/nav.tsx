...
// scrollable small-screen row; it is inert inside the md+ pill.
const pillLink =
  ...
  return (
    ...
    >
      <nav className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        {/* Small-screen pill — the same four destinations on a compact second
            row under the bar (the centered pill above is hidden below md).
            A single scrollable row keeps every link reachable on the
