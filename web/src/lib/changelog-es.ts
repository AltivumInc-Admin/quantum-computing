...
export const CHANGELOG_ES: Record<string, ChangeEntryEs> = {
  ...
  "2026-09-04-privacy-lists-every-total": {
    ...
    body: "Nuestros servidores guardan un peque\u00f1o recuento diario de c\u00f3mo se usa el sitio, calculado despu\u00e9s a partir de los registros de acceso ordinarios del alojamiento web, sin direcciones, sin identificadores y sin nada que enlace un d\u00eda con otro. La pol\u00edtica describ\u00eda solo una parte. Ahora nombra cada total: cu\u00e1ntas personas llegaron, cu\u00e1ntas iniciaron sesi\u00f3n, cu\u00e1ntas abrieron cada cuaderno de lecci\u00f3n, cu\u00e1ntas abrieron cada secci\u00f3n del curso, a cu\u00e1ntas secciones lleg\u00f3 la gente ese d\u00eda y hasta qu\u00e9 secci\u00f3n llegaron m\u00e1s lejos. No se recoge nada nuevo: esto cierra la distancia entre lo que dec\u00eda la p\u00e1gina y lo que ya se contaba.",
  },
