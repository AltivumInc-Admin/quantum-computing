...
export const GLOSSARY: GlossaryTerm[] = [
  ...
  { term: "Bell pair", section: "01-foundations", aliases: ["Bell state", "EPR pair", "EPR"],
  ...
  { term: "Bloch sphere", section: "01-foundations",
    definition: "A geometric picture of one qubit as a point on a unit sphere: $\\ket{0}$ at the north pole, $\\ket{1}$ at the south, equal superpositions around the equator.",
    seeAlso: ["Qubit"] },
  ...
  { term: "Hermitian operator", section: "03-algorithms", aliases: ["self-adjoint", "observable"],
  ...
  { term: "Eigenvalue", section: "03-algorithms",
  ...
  { term: "Eigenvector", section: "03-algorithms", aliases: ["eigenstate"],
  ...
  { term: "No-cloning theorem", section: "01-foundations", aliases: ["no cloning"],
  ...
  { term: "QPU", section: "02-hardware", aliases: ["quantum processing unit"],
    definition: "A Quantum Processing Unit — real quantum hardware; on Braket these are the IonQ, IQM, Rigetti, AQT, and QuEra devices, billed per task plus per shot.",
  ...
  { term: "Quantum simulator", section: "02-hardware", aliases: ["SV1", "DM1", "TN1", "simulator"],
    definition: "Classical software that computes a circuit's result; Braket offers SV1 (exact state vector) and DM1 (density matrix, models noise). A third, TN1 (tensor network), is retired — AWS withdrew it, so the ladder now tops out at SV1 for large circuits.",
  ...
  { term: "Readout error", section: "02-hardware", aliases: ["measurement error", "SPAM error"],
    definition: "The chance that measuring a qubit reports the wrong value, e.g. reading a $\\ket{0}$ as $\\ket{1}$; the measurement half of SPAM (state-preparation-and-measurement) error, and a distinct source from gate noise.",
  ...
  { term: "Quantum teleportation", section: "01-foundations", aliases: ["teleportation"],
  ...
  { term: "Superdense coding", section: "01-foundations", aliases: ["dense coding"],
  ...
  { term: "Parameter-shift rule", section: "04-quantum-ml", aliases: ["parameter shift"],
  ...
  { term: "Barren plateau", section: "04-quantum-ml", aliases: ["barren plateaus"],
  ...
  { term: "Trotterization", section: "05-quantum-chemistry", aliases: ["Trotter–Suzuki", "Trotter-Suzuki", "Trotter decomposition"],
  ...
  { term: "Mixer Hamiltonian", section: "06-hybrid-jobs", aliases: ["mixer"],
    definition: "In QAOA, the operator $B$ (typically $\\sum_q X_q$) whose unitary $e^{-i\\beta B}$ spreads amplitude between candidate solutions so that good assignments can grow.",
